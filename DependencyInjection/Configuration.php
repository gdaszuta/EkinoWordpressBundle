        ...
        $node
            ->children()
                ...
                ->children()
                    ...
                    ->addDefaultsIfNotSet()
                        ->children()
                            ->scalarNode('class')->cannotBeEmpty()->defaultValue('Ekino\WordpressBundle\Entity\TermMeta')->end()
                            ->scalarNode('manager')->cannotBeEmpty()->defaultValue('ekino.wordpress.manager.term_meta_default')->end()
                            ->scalarNode('repository_class')->cannotBeEmpty()->defaultValue('Ekino\WordpressBundle\Repository\TermMetaRepository')->end()
                        ->end()
                    ->end()
